"""autogenerated by genmsg_py from GetSearchPositionRequest.msg. Do not edit."""
...
class GetSearchPositionRequest(roslib.message.Message):
...
"""autogenerated by genmsg_py from GetSearchPositionResponse.msg. Do not edit."""
import roslib.message
import struct
...
class GetSearchPositionResponse(roslib.message.Message):
...
class GetSearchPosition(roslib.message.ServiceDefinition):

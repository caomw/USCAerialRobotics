/* Auto-generated by genmsg_cpp for file /home/russell/ros/USCAerialRobotics/icp_lrf/msg/Lines.msg */
#ifndef ICP_LRF_MESSAGE_LINES_H
#define ICP_LRF_MESSAGE_LINES_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct Lines_ {
  ...
  typedef boost::shared_ptr< ::icp_lrf::Lines_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::icp_lrf::Lines_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct Lines
typedef  ::icp_lrf::Lines_<std::allocator<void> > Lines;

typedef boost::shared_ptr< ::icp_lrf::Lines> LinesPtr;
typedef boost::shared_ptr< ::icp_lrf::Lines const> LinesConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::icp_lrf::Lines_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::icp_lrf::Lines_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::icp_lrf::Lines_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::icp_lrf::Lines_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::icp_lrf::Lines_<ContainerAllocator> > {
  static const char* value() 
  {
    return "5e886f1edefc993f520f05d33f4e8b92";
  }

  static const char* value(const  ::icp_lrf::Lines_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x5e886f1edefc993fULL;
  static const uint64_t static_value2 = 0x520f05d33f4e8b92ULL;
};

template<class ContainerAllocator>
struct DataType< ::icp_lrf::Lines_<ContainerAllocator> > {
  static const char* value() 
  {
    return "icp_lrf/Lines";
  }
...
template<class ContainerAllocator>
struct Definition< ::icp_lrf::Lines_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct Serializer< ::icp_lrf::Lines_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::icp_lrf::Lines_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::icp_lrf::Lines_<ContainerAllocator> & v) 
  {
